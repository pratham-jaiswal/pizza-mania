...
if($_SERVER['REQUEST_METHOD']=="POST"){
    if(empty(trim($_POST['username'])) || empty(trim($_POST['password']))){
        ...
        $sql = "SELECT id, fullname, email, username, password, admin FROM loginform WHERE username = '".trim($_POST['username'])."'";
            ...
            <section class="login-page">
                <div class="login-input">
                    <div class="login-details">
                        ...
                        <input type="text" name="username" id="username" placeholder="fatherofpizza">
                    </div>
                    <div class="login-details"> <span style="color:red;"><?php echo $perr;?></span>
                        <label for="password">Password</label>
                        <input type="password" name="password" id="password" placeholder="pizza1889">
                    </div>
                </div>
                <div class="login-btn">
                    <button>Login</button>
