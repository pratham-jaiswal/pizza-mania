            ...
            <section class="payment-page">
                ...
                <div class="payment-details">
                    ...
                    <div class="pay-details">
                        ...
                        <input type="text" name="fullname" id="fullname" placeholder="Raffaele Esposito">
                    </div>
                    <div class="pay-details">
                        <label for="email">Email</label> <span style="color:red;"><?php echo $email_err;?></span>
                        <input type="email" name="email" id="email" placeholder="icreatedpizza@pizza.io">
                    </div>
                    <div class="pay-details">
                        <label for="cname">Name on Card</label> <span style="color:red;"><?php echo $cname_err;?></span>
                        <input type="text" name="cname" id="cname" placeholder="Raffaele Esposito">
                    </div>
                    <div class="pay-details">
