            ...
            <section class="register-page">
                <div class="register-input">
                    <div class="register-details">
                        ...
                        <input type="text" class="form-control" name="fullname" id="fullname" placeholder="Raffaele Esposito">
                    </div>
                    <div class="register-details">
                        <label for="email">Email</label> <span style="color:red;"><?php echo $email_err;?></span>
                        <input type="email" class="form-control" name="email" id="email" placeholder="icreatedpizza@pizza.io">
                    </div>
                    <div class="register-details">
                        <label for="username">Username</label> <span style="color:red;"><?php echo $username_err;?></span>
                        <input type="text" class="form-control" name="username" id="username" placeholder="fatherofpizza">
                    </div>
                    <div class="register-details">
                        <label for="password">Password</label> <span style="color:red;"><?php echo $password_err;?></span>
                        <input type="password" class="form-control" name="password" id="password" placeholder="pizza1889">
                    </div>
                </div>
